...
[Watch the demo video](https://github.com/dhiraj7kr/ASSETS/blob/main/288429758-2500f636-c66d-46ad-bb68-1d55f04ce753.mp4)
...
1. Clone the repository to your local machine.
   ```bash
   git clone https://github.com/dhiraj7kr/ChatPDF.git
   ```
